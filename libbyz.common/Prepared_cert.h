...
inline int Prepared_cert::num_complete() const
{
...
inline int Prepared_cert::pc_num_complete()
{
  return pc.num_complete();
}

inline int Prepared_cert::pc_num_correct()
{
  return pc.num_correct();
}
...
inline BR_map Prepared_cert::missing_reqs() const
{
