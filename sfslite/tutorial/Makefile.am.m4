dnl $Id: Makefile.am.m4 5233 2010-04-06 14:29:38Z max $
dnl
...
LDADD = $(LIBAAPP) $(LIBTAME) $(LIBSFSCRYPT) $(LIBARPC) $(LIBASYNC) $(LIBGMP) \
	$(LDADD_THR) $(LDADD_STD_ALL)
$(PROGRAMS): $(LDEPS) 
...
tame_rpcclient(perfsrv)
tame_rpcclient(perfcli)
