...
#define NEED_PREAD_DECL 1

/* Define if system headers do not declare pwrite. */
#define NEED_PWRITE_DECL 1
...
/* the frame pointer on this architecture */
#define RBP_ASM_REG "movl %%ebp"
...
/* Set A=3 implicitly in callback.h */
/* #undef SFS_CALLBACK_A3 */

/* Define if SFS libs are compiled with shared libs */
/* #undef SFS_COMPILE_SHARED */
...
/* Define to turn on a leak checker */
/* #undef SIMPLE_LEAK_CHECKER */

/* Define to turn on a simple profiler */
/* #undef SIMPLE_PROFILER */
...
/* Define if to avoid templates in tame */
/* #undef TAME_DETEMPLATIZE */
...
/* where in the ucontext object to find %rbp */
#define UCONTEXT_RBP uc_mcontext.gregs[REG_EBP]
