...
// XXX(apace): On Debian you might need to replace this #include with the 
...
public:
  ...
  //explicit bigint (str s, int base = 0) { mpz_init_set_str (this, s, base); }
...
# endif /* SIZEOF_LONG >= 8 */
  ...
  str getstr (const int base = 16) const {
